...
public class ExampleController1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// - 서버사 클라이언트에게 응답하기 위한 방법을 제공하는 객체
		
		System.out.println("--- 이름, 나이를 입력 받아 처리하는 코드 ---");
		
		// "요청" 시 입력 된 이름, 나이를 전달 받아 오기
		// parameter : 매개변수(다른 곳의 값을 전달 받아올 때 사용)
		// String req.getParameter("name 속성값");
		// -> 요청 시 전달된 데이터 중 name 속성값이 일치하는 value 를 얻어와 String 형태로 반환
		// cf. HTML에서 얻어오는 모든 값은 String 타입이다.
