...
<%-- core : 제일 많이 사용하는 코드 모음(if, choose, forEach 등) --%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%-- 문자열 관련, 배열/리스트 관련 기능 모음(태그 형태가 아닌 EL 형태로 작성하는 구문) --%>
<%-- taglibs-standard-jstlel-1.2.5.jar 에 들어있음 --%>
...
<body>
    ...
    <pre>
        ...
        - 속성
            ...
            3) end   : 반복이 종료될 var 값
            4) step  : 반복 시 마다 var의 증가 값 (기본값 1, 양수만 가능)
