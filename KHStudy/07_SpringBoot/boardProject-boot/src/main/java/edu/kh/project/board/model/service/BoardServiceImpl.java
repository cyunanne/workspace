...
//		mapper.selectList(boardCode, rowBounds);
	...
	public Map<String, Object> selectBoardList(Map<String, Object> paramMap, int cp) {
		...
		int listCount = mapper.getSearchListCount(paramMap); // Overroading
		...
		// 3) selectList("namespace.id", 파라미터, RowBounds) 호출
//		mapper.selectList(paramMap, rowBounds);
		
		List<Board> boardList = mapper.selectSearchBoardList(paramMap, rowBounds); // Overroading
