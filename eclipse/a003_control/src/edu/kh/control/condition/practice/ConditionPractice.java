...
public class ConditionPractice {
	...
	public void practice4() {
		...
		if( bmi < 18.5 ) { str = "저체중"; }
		else if( bmi < 23 ) { str = "정상체중"; }
		else if( bmi < 25 ) { str = "과체중"; }
		else if( bmi < 30 ) { str = "비만"; }
		else { str = "고도비만"; }
	...
	public void practice5() {
		...
		Scanner sc = new Scanner(System.in);
		double middleGrade, finalGrade, assignment, attendance, total;
		String result;
		
		System.out.print("중간 고사 점수 : "); 
		middleGrade = sc.nextDouble();
		...
		total = (middleGrade * 0.2) + (finalGrade * 0.3) + (assignment * 0.3) + (attendance * 0.2);
		
		System.out.println("================= 결과 =================");
		System.out.println("중간 고사 점수(20) : " + middleGrade);
		System.out.println("기말 고사 점수(30) : " + finalGrade);
