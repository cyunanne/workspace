...
public class ArrayEx1 {
	...
	public void ex5() {
		...
		// 문 제 점: for문의 조건식에서 i의 범위가 Arr배열의 인덱스 범위를 초과하여 실행시 for문 내 출력 구문에서 ArrayIndexOutOfBoundsException 발생
		// 해결방법: 조건식을 i < arr.length 로 수정하여 i가 배열의 인덱스 범위를 초과하지 않도록 수정
